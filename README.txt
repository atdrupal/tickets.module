...
You can add ticket entities via
...
searching and replacing the word "ticket" with the actual name I want to give my
...
ticket.admin.inc and customize the behaviour of your entity on save, delete which you
do via the TicketController class in ticket.module.
...
to your table)  - just like the ticket entity does with the checkbox - there is nothing
else you need to do. If you have added new columns you need to add support for them
in $ticket->create but not necessarily $ticket->save unless you are doing something specific.

3. Finally you can play around within the theming for your entity by looking into ticket.tpl.php and
ticket-sample-data.tpl.php
