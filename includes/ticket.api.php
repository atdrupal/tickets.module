...
*
* @param $entities
*   An array of ticket entities being loaded, keyed by id.
*
* @see hook_entity_load()
*/
function hook_ticket_load($entities) {
  $result = db_query('SELECT ticket_id, foo FROM {mytable} WHERE ticket_id IN(:ids)', array(':ids' => array_keys($entities)));
  foreach ($result as $record) {
    $entities[$record->ticket_id]->foo = $record->foo;
  }
}
...
*/
function hook_ticket_insert($ticket) {
  db_insert('mytable')
    ->fields(array(
...
*/
function hook_ticket_presave($ticket) {
  $ticket->extra = 'foo';
}
...
*
* @param $ticket
*   The $ticket that is being updated.
*
* @see hook_entity_update()
*/
function hook_ticket_update($ticket) {
  db_update('mytable')
    ->fields(array('extra' => $ticket->extra))
...
*/
function hook_ticket_delete($ticket) {
  db_delete('mytable')
    ->condition('ticket_id', $ticket->ticket_id)
    ->execute();
}
...
*
* The module may add elements to $ticket->content prior to rendering. The
* structure of $ticket->content is a renderable array as expected by
* drupal_render().
*
* @see hook_entity_prepare_view()
* @see hook_entity_view()
*/
function hook_ticket_view($ticket, $view_mode, $langcode) {
  $ticket->content['my_additional_field'] = array(
...
* callback. Alternatively, it could also implement hook_preprocess_ticket().
* See drupal_render() and theme() documentation respectively for details.
*
* @see hook_entity_view_alter()
*/
function hook_ticket_view_alter($build) {
